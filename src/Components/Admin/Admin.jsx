        ...
        <>
            <div className='container text-center my-5 py-5' style={{ color: "rgb(189, 4, 4)" }}>
                <div className="row my-5">
                    ...
                    <NavLink to={"/Moviecrud"} className="col-md-3 m-auto rounded-5 shadow-lg p-2 my-3" style={{ border: "1px solid rgb(189, 4, 4)" }}>

                        <div className="card-hell ">
                            <img src={admin1} className=" img-fluid" style={{ width: "300px", height: "300px" }} alt="..." />
                            <p className="display-6 text-danger">Movie Handler</p>
                        </div>
                    </NavLink>
                    ...
                    <NavLink to={"/TheaterCrud"} className="col-md-3 m-auto rounded-5 shadow-lg p-2 my-3" style={{ border: "1px solid rgb(189, 4, 4)" }}>
                        <div className="card-hell ">
                            <img src={admin3} className=" img-fluid" style={{ width: "300px", height: "300px" }} alt="..." />
                            <p className="display-6 text-danger">Theater Handler</p>
                        </div>
                    </NavLink>
